...
//   return (
//     <div className='grid md:w-[88%] mt-8 xl:w-[90%]  place-items-center mx-auto md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 3xl:grid-cols-6 sm:grid-cols-1 gap-6'>
